...
Check the [releases](https://github.com/droboports/fuse/releases) page. If there are no releases available, then you have to compile.
...
```
git clone https://github.com/droboports/fuse.git
cd fuse
./build.sh
ls -la *.tgz
```
